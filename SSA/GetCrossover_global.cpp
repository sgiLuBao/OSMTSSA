...
//	  printf("\n");
	  ...
	  {
         par_best[i].s=NPbest.edge[i*3-2];
		 par_best[i].e=NPbest.edge[i*3-1];
		 par_best[i].line_style=NPbest.edge[i*3];
...
void GetCrossover_global_SSA(int cur,int CrRate)
{
    double c;
	int i,j,mid=0,sign1[1010],sign2[1010],count_new,count_sur;
	c=rand()/(RAND_MAX+1.0); 
